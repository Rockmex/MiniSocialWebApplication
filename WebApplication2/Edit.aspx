...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                <div class="word">
                    ...
                    <table id="t01">
						<tr>
							<td colspan="3" class="td_center"><h3>Edit</h3></td>						
						</tr>
                        <tr>
						...
						<tr>
							<td colspan="3" style="text-align:center;"><asp:Button ID="Button_Back" Text="Back" OnClick="Button_Click_Back" runat="server" ></asp:Button></td>						
						</tr>
					</table>
                   </div>
                </div>
                        ...
                        <script type="text/javascript">
                          ...
                          <div class="popup">
                            <div class="word">
                                ...
                                <table id="t02">
						            <tr>
							            <td colspan="2" class="td_center"><h3>Edit_Email</h3></td>						
						            </tr>
                                    <tr>
                                        <td class="td_left"><asp:Label ID= "label_Email" Text="New Email: " runat="server"></asp:Label></td>
                                        <td class="td_right"><asp:Textbox ID="new_email" runat="server"></asp:Textbox></td>
                                    </tr>
						            <tr>
							            <td colspan="2" style="text-align:center;"><asp:Button ID="Button_Update" Text="Update" OnClick="Button_Click_Update" runat="server" /><asp:Button ID="Button1" Text="Back" OnClick="Button_Click_Back2" runat="server" /></td>						
						            </tr>
					            </table>
                           </div>
                        </div>
                    ...
                    <asp:HiddenField Value="" ID="HiddenField1" runat="server"/>
                        ...
                        <div class="word">
                            ...
                            <table id="t03">
						        ...
						        <tr>
							        <td colspan="2" style="text-align:center;"><asp:Button ID="Button2" Text="Update" OnClick="Button_Click_Update2" runat="server" /><asp:Button ID="Button3" Text="Back" OnClick="Button_Click_Back2" runat="server" /></td>						
						        </tr>
					        </table>
                        </div>
                     </div>
                        ...
                        <div class="word">
                             <div class ="menu">
                                <table id="t04">
						            ...
						            <tr>
							            <td colspan="2" style="text-align:center;"><asp:Button ID="Button4" Text="Update" OnClick="Button_Click_Update3" runat="server" /><asp:Button ID="Button5" Text="Back" OnClick="Button_Click_Back2" runat="server" /></td>						
						            </tr>
					            </table>
                            </div>
                        </div>
