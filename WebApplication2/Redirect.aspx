            ...
            <div class="rg_form">
                <div class="word">
                        <table id="CreateRoom">
                            ...
                            <tr>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Friend ID">  
                                        <EditItemTemplate>  
                                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("User2_Id") %>'></asp:TextBox>  
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("User2_Id") %>'></asp:Label>  
                                        </ItemTemplate>  
                                    </asp:TemplateField>
                            ...
                            <tr>
                                <td colspan="2" align="center"><asp:Button ID="Button1" runat="server" Text="Create" OnClick="Button_Click_CreatRoom" />
                            </tr>
                        </table>
                        <table id="AddMember">
                            <tr>
                                <td colspan="2" class="td_center"><h3>Add Member</h3></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2" align="center"><asp:Button ID="Button2" runat="server" Text="Add" OnClick="Button_Click_AddMember" />
                            </tr>
                        </table>
                     </div>
                   </div>
